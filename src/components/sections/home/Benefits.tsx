              ...
              <div className="flex flex-col lg:flex-row justify-between items-center">
                ...
                <div className="w-full lg:w-1/3 space-y-4">
                  <div className="text-center p-4">
                    <h3 className="font-bold text-xl 2xl:text-2xl 3xl:text-3xl mb-2">Calm Your<br/> Inner World</h3>
                  ...
                  <div className="text-center p-4">
                    <h3 className="font-bold text-xl 2xl:text-2xl 3xl:text-3xl mb-2">Feel Wonderfully <br/>Present</h3>
                    <p className="text-sm 2xl:text-base 3xl:text-lg text-gray-600">
                  ...
                  <div className="text-center p-4">
                    <h3 className="font-bold text-xl 2xl:text-2xl 3xl:text-3xl mb-2">Find Your<br/> Mental Reset</h3>
                    <p className="text-sm 2xl:text-base 3xl:text-lg text-gray-600">
                ...
                <div className="w-full lg:w-1/3 space-y-4">
                  <div className="text-center p-4">
                    <h3 className="font-bold text-xl 2xl:text-2xl 3xl:text-3xl mb-2">Strengthen from the<br/> Inside Out</h3>
                    <p className="text-sm 2xl:text-base 3xl:text-lg text-gray-600">
                  ...
                  <div className="text-center p-4">
                    <h3 className="font-bold text-xl 2xl:text-2xl 3xl:text-3xl mb-2">Ease Into<br/> Restful Sleep</h3>
                    <p className="text-sm 2xl:text-base 3xl:text-lg text-gray-600">
                  ...
                  <div className="text-center p-4">
                    <h3 className="font-bold text-xl 2xl:text-2xl 3xl:text-3xl mb-2">Sharpen Your Mental<br/> Flow</h3>
                    <p className="text-sm 2xl:text-base 3xl:text-lg text-gray-600">
