...
const Explaination = () => {
  ...
  <div className="flex flex-col items-center justify-center py-10 sm:py-16 md:py-20 px-4 sm:px-6 lg:px-8 max-w-screen-2xl 2xl:max-w-[90%] 3xl:max-w-[85%] mx-auto gap-8 sm:gap-12 md:gap-20">
      ...
      <div className="w-full flex flex-col md:flex-row gap-6 sm:gap-10">
        <div className="w-full md:w-1/2">
          <h3 className="text-base sm:text-[16px] 2xl:text-lg 3xl:text-xl text-[#0D0A09] mb-2 sm:mb-4">Our Mission</h3>
          <h2 className="text-2xl sm:text-4xl md:text-5xl 2xl:text-6xl 3xl:text-7xl font-bold mb-4 sm:mb-6">To empower individuals to unlock their mind's full potential</h2>
        </div>
        <div className="w-full md:w-3/5 text-[16px]">
          <p className="text-sm sm:text-base md:text-lg 2xl:text-xl 3xl:text-2xl text-gray-700">
          ...
          <p className="text-sm sm:text-base md:text-lg 2xl:text-xl 3xl:text-2xl text-gray-700 mt-2 sm:mt-4">
  ...
  <div className="mt-3 sm:mt-4 md:mt-0"></div>
      <div className="w-full flex flex-col md:flex-row gap-6 sm:gap-10">
        <div className="w-full md:w-1/2">
          <h3 className="text-base sm:text-[16px] 2xl:text-lg 3xl:text-xl text-[#0D0A09] mb-2 sm:mb-4">Our Vision</h3>
          <h2 className="text-2xl sm:text-4xl md:text-5xl 2xl:text-6xl 3xl:text-7xl font-bold mb-4 sm:mb-6">To redefine how the world approaches mental health</h2>
        </div>
        <div className="w-full md:w-3/5 text-[16px]">
          <p className="text-sm sm:text-base md:text-lg 2xl:text-xl 3xl:text-2xl text-gray-700">
