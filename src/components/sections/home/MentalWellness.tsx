    ...
    <div className="py-10 sm:py-16 md:py-20 flex justify-between">
      <div className="max-w-screen-2xl 2xl:max-w-[90%] 3xl:max-w-[85%] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <Card
            className="group hover:shadow-lg hover:shadow-mind-violet/10 h-[380px] sm:h-[420px] md:h-[464px] 2xl:h-[600px] 3xl:h-[720px] w-full transition-all duration-300 overflow-hidden p-0 glass-card flex-shrink-0 cursor-pointer rounded-xl md:rounded-2xl lg:rounded-3xl"
          ...
          >
            <div className="flex flex-col md:flex-row h-full">
              ...
              <div className="flex flex-col justify-between p-6 md:p-8 order-2 md:order-1 md:w-1/2">
                ...
                <div className="mt-20">
                  <button className="text-xs sm:text-sm font-medium text-gray-400 hover:text-white flex items-center group">
                    Who We Are 
          ...
          <Card
            className="group hover:shadow-lg hover:shadow-mind-violet/10 h-[380px] sm:h-[420px] md:h-[464px] 2xl:h-[600px] 3xl:h-[720px] w-full transition-all duration-300 overflow-hidden p-0 flex flex-col glass-card flex-shrink-0 cursor-pointer rounded-xl md:rounded-2xl lg:rounded-3xl"
            onClick={handleCardClick}
          >
