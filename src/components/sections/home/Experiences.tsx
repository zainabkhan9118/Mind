        ...
        <div className="flex items-start justify-between gap-2">
          ...
          <div className="flex items-center justify-center w-16 h-16 border border-white rounded-full flex-shrink-0 mt-1">
            <ArrowRight className="text-white" size={20} />
              ...
              <Card className="group hover:shadow-lg text-white w-full md:w-[48%] lg:w-[624px] h-[340px] sm:h-[420px] md:h-[668px] border-none transition-shadow duration-300 overflow-hidden p-0 flex-shrink-0 relative">
